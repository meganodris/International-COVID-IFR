...
transformed parameters {
  ...
  // time series of seroprevalence
  matrix[Ndays-serotodeath,NArea] seroT;
  ...
  for(c in 1:NArea){
    seroT[1:(Ndays-serotodeath),c] = (probInfec[c]/deathsT[TdeathsA[c],c])*to_vector(deathsT[serotodeath+1:Ndays,c]);
  }
}
